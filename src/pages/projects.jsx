      ...
      <section data-aos="fade-up"
        ...
        <div className="flex  lg:space-y-4 space-y-8 flex-col">
          {projects.map((data, index) => {
            ...
            return (
              <a href={liveUrl} key={index} className="rounded-xl shadow-sm py-3 shadow-blue-600 no-underline outline-none group" target="_blank" rel="noreferrer">
                  ...
                  <div className="basis-3/4">
                    ...
                    <div className="mt-5 flex gap-2 items-center">
                      {tools.map((data, index) => {
                        return (
                          <div key={index} className="py-1.5 px-3 shadow-sm shadow-blue-800 bg-blue-500 bg-opacity-10 text-[12px] xl:text-[12px] lg:text-[8px] rounded-full text-blue-300">
                            {data}
                          </div>
                        )
                      })}
